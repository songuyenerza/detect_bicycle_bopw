    ...
    for i, det in enumerate(pred):  # per image
        ...
        if len(det):
            ...
            for *xyxy, conf, cls in reversed(det):
                ...
                if box[4] in {6,8,20,21,16}:
                    if box[4] == 8:
                        # print("check++++=====")
                        # print(box)
                        x0, y0, x1, y1, label, conf = box
                        h = y1 - y0
                        box = [x1 - h, y0, x1, y1, label, conf]
                        # print(im0.shape)
        ...
        if len(box_image) > 5:
            ...
            box4 = maxx(box4)
            try:
                box_image = [box0[0], box1[0], box2[0], box3[0], box4[0]]
            except:
                print(box0, box1, box2, box3, box4)
...
if __name__ == "__main__":
    folder_img = "/home/anlab/Desktop/Songuyen/PIl_detection/data_bicycle/images/data_rotate301122/test/"
    folder_output = "/home/anlab/Desktop/Songuyen/PIl_detection/data_bicycle/images/data_rotate301122/test_demo/"
    weight = "/media/anlab/0e731fe3-5959-4d40-8958-e9f6296b38cb/home/anlab/songuyen/detect_bycicle/CP/best_21class.pt"
    ...
    tt = 0
    err = 0
    with open('/home/anlab/Desktop/Songuyen/PIl_detection/data_bicycle/images/data_rotate301122/test/paths.txt','r') as f:
    ...
    for path in IMAGE_PATH_DB:
        ...
        img_ori = cv2.resize(img_ori, (600, int(center[0]*600/center[1])))
        ...
        _str = '|'.join([str(elem) for elem in box_img])
        APP_CODE = 'YOLOv5'
        rst = f"{tt},{APP_CODE},{path},{_str}, {img_ori.shape}"
        tt+=1

        with open('/home/anlab/Desktop/Songuyen/PIl_detection/data_bicycle/images/data_rotate301122/test/bicycle_yolo_5_box.csv', 'a') as f:
            f.write(f'{rst}\n')
